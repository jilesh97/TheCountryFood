...
window.averta = {},
    ...
    function(n) {
        ...
        this.type = n
    }, MSSliderEvent.CHANGE_START = "changeStart", MSSliderEvent.CHANGE_END = "changeEnd", MSSliderEvent.WATING = "wating", MSSliderEvent.AUTOPLAY_CHANGE = "autoplayChange", MSSliderEvent.VIDEO_PLAY = "videoPlay", MSSliderEvent.VIDEO_CLOSE = "videoClose", MSSliderEvent.INIT = "init",
    function(n) {
        "use strict";
    ...
    function(n) {
        ...
        window.MasterSlider = function() {
            ...
            if (!this.preventInit) {
                ...
                if (this.__setupSlides(), this.slideController.setup(), this.controls)
            ...
            if (this.controls)
                for (var n = 0, t = this.controls.length; n < t; ++n) this.controls[n].destroy();
